...
def split_infobox():
    ...
    *.box.pos is the position counted from the begining of a field
    """
    bwfile = [os.path.join(os.path.dirname(__file__), "processed_data/train/train.box.val"),
              os.path.join(os.path.dirname(__file__), "processed_data/valid/valid.box.val"), 
              os.path.join(os.path.dirname(__file__), "processed_data/test/test.box.val")]
    bffile = [os.path.join(os.path.dirname(__file__), "processed_data/train/train.box.lab"), 
              os.path.join(os.path.dirname(__file__), "processed_data/valid/valid.box.lab"), 
              os.path.join(os.path.dirname(__file__), "processed_data/test/test.box.lab")]
    bpfile = [os.path.join(os.path.dirname(__file__), "processed_data/train/train.box.pos"), 
              os.path.join(os.path.dirname(__file__), "processed_data/valid/valid.box.pos"), 
              os.path.join(os.path.dirname(__file__), "processed_data/test/test.box.pos")]
    boxes = [os.path.join(os.path.dirname(__file__), "original_data/train.box"),
             os.path.join(os.path.dirname(__file__), "original_data/valid.box"),
             os.path.join(os.path.dirname(__file__), "original_data/test.box")]
...
def reverse_pos():
    ...
    bpfile = [os.path.join(os.path.dirname(__file__), "processed_data/train/train.box.pos"),
              os.path.join(os.path.dirname(__file__), "processed_data/valid/valid.box.pos"),
              os.path.join(os.path.dirname(__file__), "processed_data/test/test.box.pos")]
    bwfile = [os.path.join(os.path.dirname(__file__), "processed_data/train/train.box.rpos"),
              os.path.join(os.path.dirname(__file__), "processed_data/valid/valid.box.rpos"),
              os.path.join(os.path.dirname(__file__), "processed_data/test/test.box.rpos")]
...
def check_generated_box():
    ftrain = [os.path.join(os.path.dirname(__file__), "processed_data/train/train.box.val"),
              os.path.join(os.path.dirname(__file__), "processed_data/train/train.box.lab"),
              os.path.join(os.path.dirname(__file__), "processed_data/train/train.box.pos"),
              os.path.join(os.path.dirname(__file__), "processed_data/train/train.box.rpos")]
    ftest  = [os.path.join(os.path.dirname(__file__), "processed_data/test/test.box.val"), 
              os.path.join(os.path.dirname(__file__), "processed_data/test/test.box.lab"),
              os.path.join(os.path.dirname(__file__), "processed_data/test/test.box.pos"),
              os.path.join(os.path.dirname(__file__), "processed_data/test/test.box.rpos")]
    fvalid = [os.path.join(os.path.dirname(__file__), "processed_data/valid/valid.box.val"), 
              os.path.join(os.path.dirname(__file__), "processed_data/valid/valid.box.lab"), 
              os.path.join(os.path.dirname(__file__), "processed_data/valid/valid.box.pos"),
              os.path.join(os.path.dirname(__file__), "processed_data/valid/valid.box.rpos")]
...
def split_summary_for_rouge():
    bpfile = [os.path.join(os.path.dirname(__file__), "original_data/test.summary"),
              os.path.join(os.path.dirname(__file__), "original_data/valid.summary")]
    bwfile = [os.path.join(os.path.dirname(__file__), "processed_data/test/test_split_for_rouge/"),
              os.path.join(os.path.dirname(__file__), "processed_data/valid/valid_split_for_rouge/")]
...
class Vocab(object):
    ...
    def __init__(self):
        ...
        vocab['UNK_TOKEN'] = 3
        cnt = 4
        with open(os.path.join(os.path.dirname(__file__), "original_data/word_vocab.txt"), "r") as v:
            for line in v:
        ...
        key_map['UNK_TOKEN'] = 3
        cnt = 4
        with open(os.path.join(os.path.dirname(__file__), "original_data/field_vocab.txt"), "r") as v:
            for line in v:
...
def table2id():
    fvals = [os.path.join(os.path.dirname(__file__), 'processed_data/train/train.box.val'),
             os.path.join(os.path.dirname(__file__), 'processed_data/test/test.box.val'),
             os.path.join(os.path.dirname(__file__), 'processed_data/valid/valid.box.val')]
    flabs = [os.path.join(os.path.dirname(__file__), 'processed_data/train/train.box.lab'),
             os.path.join(os.path.dirname(__file__), 'processed_data/test/test.box.lab'),
             os.path.join(os.path.dirname(__file__), 'processed_data/valid/valid.box.lab')]
    fsums = [os.path.join(os.path.dirname(__file__), 'original_data/train.summary'),
             os.path.join(os.path.dirname(__file__), 'original_data/test.summary'),
             os.path.join(os.path.dirname(__file__), 'original_data/valid.summary')]
    fvals2id = [os.path.join(os.path.dirname(__file__), 'processed_data/train/train.box.val.id'),
                os.path.join(os.path.dirname(__file__), 'processed_data/test/test.box.val.id'),
                os.path.join(os.path.dirname(__file__), 'processed_data/valid/valid.box.val.id')]
    flabs2id = [os.path.join(os.path.dirname(__file__), 'processed_data/train/train.box.lab.id'),
                os.path.join(os.path.dirname(__file__), 'processed_data/test/test.box.lab.id'),
                os.path.join(os.path.dirname(__file__), 'processed_data/valid/valid.box.lab.id')]
    fsums2id = [os.path.join(os.path.dirname(__file__), 'processed_data/train/train.summary.id'),
                os.path.join(os.path.dirname(__file__), 'processed_data/test/test.summary.id'),
                os.path.join(os.path.dirname(__file__), 'processed_data/valid/valid.summary.id')]
    vocab = Vocab()
